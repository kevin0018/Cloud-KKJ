...
$servers->setValue('server','base',array('dc=cloudkkj,dc=org'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=cloudkkj,dc=org');
#  $servers->setValue('login','bind_id','cn=Manager,dc=cloudkkj,dc=org');
